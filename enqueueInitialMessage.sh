...
aws sqs send-message --queue-url https://sqs.eu-west-1.amazonaws.com/525470265062/serverless-mapreduce-rawdata.fifo --message-body raw/Cars_12_2016.csv --message-group-id 1 --message-deduplication-id 2
